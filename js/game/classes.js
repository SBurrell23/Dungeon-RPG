...
export const CLASSES = {
  knight: {
    ...
    base: { hp: 128, mp: 30, str: 9, dex: 4, int: 3, vit: 11, speed: 130 },
  ...
  templar: {
    ...
    color: '#e8d9a8',
    base: { hp: 112, mp: 60, str: 8, dex: 4, int: 6, vit: 9, speed: 134 },
  ...
  swordsman: {
    ...
    role: 'Melee DPS',
    color: '#dfa8a0',
    base: { hp: 96, mp: 36, str: 8, dex: 8, int: 3, vit: 6, speed: 152 },
  ...
  soldier: {
    ...
    role: 'Melee / Skirmish',
    color: '#b9c8a8',
    base: { hp: 108, mp: 42, str: 8, dex: 6, int: 4, vit: 8, speed: 142 },
  ...
  archer: {
    ...
    role: 'Ranged DPS',
    color: '#a8d3b0',
    base: { hp: 82, mp: 44, str: 4, dex: 12, int: 4, vit: 5, speed: 148 },
  ...
  wizard: {
    ...
    role: 'Ranged AoE',
    color: '#9fb4e8',
    base: { hp: 70, mp: 96, str: 3, dex: 5, int: 13, vit: 4, speed: 138 },
  ...
  priest: {
    ...
    role: 'Healer',
    color: '#e0d0e8',
    base: { hp: 88, mp: 88, str: 4, dex: 4, int: 11, vit: 6, speed: 140 },
